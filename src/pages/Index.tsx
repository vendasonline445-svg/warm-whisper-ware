...
const reviews = [
  { name: "Carla S.", avatar: "/images/avatar-carla.webp", text: "A mesa é bem grande, boa demais! Espaçosa e super prática — montei em segundos e usei para o churrasco com a família toda. Muito resistente, suporta bastante peso sem tremer!", rating: 5, photos: ["/images/review-carla-1.webp", "/images/review-carla-2.webp"], daysAgo: 1, model: "Branca 180x60cm" },
  { name: "Patrícia F.", avatar: "/images/avatar-patricia.webp", text: "Ela é muito prática. Material bom, custo muito bom. Amei, pretendo comprar outra!", rating: 5, photos: ["/images/review-patricia-1.webp", "/images/review-patricia-2.webp"], daysAgo: 2, model: "Preta 180x60cm" },
  { name: "Raquel M.", avatar: "/images/avatar-raquel.webp", text: "Ela é linda, bem resistente. Me surpreendi com a qualidade, vou usar muito! Chegou no dia certinho.", rating: 5, photos: ["/images/review-raquel-1.webp", "/images/review-raquel-2.webp", "/images/review-raquel-3.webp"], daysAgo: 1, model: "Branca 120x60cm" },
  { name: "Karine Porto", avatar: "/images/avatar-karine.webp", text: "Muito boa, bem reforçada. Veio bem embalada na caixa, sem avarias. Gostei muito da mesa!", rating: 5, photos: ["/images/review-karine-1.webp", "/images/review-karine-2.webp", "/images/review-karine-3.webp"], daysAgo: 2, model: "Branca 180x60cm" },
  { name: "Juliana P.", avatar: "/images/avatar-juliana.webp", text: "Adorei a minha compra! Chegou no prazo, veio bem embalada. A mesa é linda e muito resistente. Ideal para quem tem pouco espaço, ela é bem fácil para montar. Gosteiii muitoooooo! 😍", rating: 5, photos: ["/images/review-juliana-1.webp", "/images/review-juliana-2.webp"], daysAgo: 1, model: "Preta 150x60cm" },
  { name: "Fernanda L.", avatar: "/images/avatar-carla.webp", text: "Mesa maravilhosa! Usei no aniversário do meu filho e coube tudo. Super estável, não balança nada. Recomendo demais!", rating: 5, photos: [], daysAgo: 2, model: "Branca 240x60cm" },
  { name: "Lucas R.", avatar: "/images/avatar-karine.webp", text: "Comprei para usar no apartamento pequeno. Quando não preciso, fecho e guardo atrás do armário. Perfeita!", rating: 5, photos: [], daysAgo: 1, model: "Preta 120x60cm" },
  { name: "Amanda Costa", avatar: "/images/avatar-patricia.webp", text: "Entrega super rápida! A mesa veio muito bem embalada. Qualidade excelente pelo preço. Já indiquei pra minha vizinha.", rating: 5, photos: [], daysAgo: 2, model: "Branca 180x60cm" },
  { name: "Roberto S.", avatar: "/images/avatar-karine.webp", text: "Surpreendeu demais! Achei que ia ser frágil mas é muito resistente. Coloquei um monte de coisa em cima e ficou firme.", rating: 5, photos: [], daysAgo: 1, model: "Preta 180x60cm" },
  { name: "Mariana Oliveira", avatar: "/images/avatar-raquel.webp", text: "Já é a segunda que compro! A primeira durou 3 anos de uso pesado. Qualidade top. Nota 10!", rating: 5, photos: [], daysAgo: 2, model: "Branca 150x60cm" },
  { name: "Sandra B.", avatar: "/images/avatar-juliana.webp", text: "Usei pra montar minha barraquinha de feira e foi perfeita. Leve pra carregar e monta rapidinho. Amei! ❤️", rating: 5, photos: [], daysAgo: 1, model: "Branca 240x60cm" },
  { name: "Thiago M.", avatar: "/images/avatar-karine.webp", text: "Mesa com ótimo custo-benefício. Superfície lisa, fácil de limpar. Pés bem firmes no chão.", rating: 5, photos: [], daysAgo: 2, model: "Preta 180x60cm" },
  { name: "Camila Souza", avatar: "/images/avatar-carla.webp", text: "Comprei pro escritório em casa e ficou ótima! Espaçosa, bonita e muito prática de guardar.", rating: 4, photos: [], daysAgo: 1, model: "Branca 180x60cm" },
  { name: "Diego F.", avatar: "/images/avatar-karine.webp", text: "Produto excelente! Usei em um evento e todo mundo perguntou onde comprei. Muito bonita e resistente.", rating: 5, photos: [], daysAgo: 2, model: "Preta 240x60cm" },
  { name: "Beatriz Almeida", avatar: "/images/avatar-patricia.webp", text: "Chegou antes do prazo! A mesa é exatamente como nas fotos. Montagem super fácil, fiz sozinha.", rating: 5, photos: [], daysAgo: 1, model: "Branca 150x60cm" },
  { name: "Carlos H.", avatar: "/images/avatar-karine.webp", text: "Comprei a branca e ficou linda na varanda. Material de qualidade, não enferruja. Muito satisfeito!", rating: 5, photos: [], daysAgo: 2, model: "Branca 180x60cm" },
  { name: "Priscila N.", avatar: "/images/avatar-raquel.webp", text: "Mesa perfeita pro dia a dia! Uso pra tudo: refeições, trabalho, artesanato. Super versátil.", rating: 5, photos: [], daysAgo: 1, model: "Preta 150x60cm" },
  { name: "Ana Paula G.", avatar: "/images/avatar-juliana.webp", text: "Melhor compra que fiz esse ano! A mesa é incrível, muito prática e o acabamento é lindo. Super recomendo! 🌟", rating: 5, photos: [], daysAgo: 2, model: "Branca 180x60cm" },
  { name: "Marcos Vinícius", avatar: "/images/avatar-karine.webp", text: "Levei pro acampamento e foi show! Leve, fácil de transportar na maleta. Cabe no porta-malas tranquilo.", rating: 5, photos: [], daysAgo: 1, model: "Preta 180x60cm" },
  { name: "Gabriela T.", avatar: "/images/avatar-carla.webp", text: "Nota 1000! A mesa é linda, resistente e super prática. Minha família toda adorou. Vou comprar outra pro sítio!", rating: 5, photos: [], daysAgo: 2, model: "Branca 240x60cm" },
];
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/20">
                  <div className="w-12 h-12 rounded-full bg-white/90 flex items-center justify-center">
                    <svg className="w-5 h-5 text-foreground ml-0.5" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                  </div>
                </div>
              </div>
            ))}
        ...
        <DialogContent className="max-w-[95vw] sm:max-w-2xl p-0 border-0 bg-transparent shadow-none [&>button]:hidden">
          ...
          <div
            ...
            onTouchMove={(e) => {
              ...
              if (Math.abs(dx) > Math.abs(dy) && Math.abs(dx) > 10) { swiping.current = true; e.preventDefault(); }
              touchEndX.current = e.touches[0].clientX;
            }}
            onTouchEnd={(e) => {
              const diffX = touchStartX.current - touchEndX.current;
              const diffY = e.changedTouches[0].clientY - touchStartY.current;
              if (diffY > 100) { setZoomOpen(false); return; }
        ...
        <div className="fixed inset-0 z-[60]" onClick={() => { setExitModalOpen(false); if (!exit2Shown) { setExit2Open(true); setExit2Shown(true); fireAlertSiren(); } }}>
          ...
          >
            ...
            <div className="px-5 pb-6">
              ...
              >
                Aproveitar desconto <span className="inline-block animate-[wiggle_1s_ease-in-out_infinite]">🔥</span> - R$ {((SIZE_PRICES[selectedSize]?.price ?? 69.90) * 0.75).toFixed(2).replace('.', ',')}
              </button>
