...
const productImages = [
  "/images/eco/eco-produto-hero.webp",
...
const reviews = [
  ...
  { name: "Carlos Eduardo B.", avatar: "/images/avatar-karine.webp", text: "Vi no Shark Tank e resolvi testar. Não me arrependo! A conta que era R$280 caiu pra R$180. Produto de qualidade.", rating: 5, photos: ["/images/eco/review-combo-1.webp"], daysAgo: 2 },
  { name: "Fernanda Lima", avatar: "/images/avatar-juliana.webp", text: "Já é o terceiro que compro — coloquei na casa dos meus pais e na da sogra também. Todo mundo economizando! 💧", rating: 5, photos: ["/images/eco/review-combo-2.webp"], daysAgo: 1 },
  { name: "Roberto Alves", avatar: "/images/avatar-karine.webp", text: "Estava pagando absurdos de conta de água. Com o Economizare a diferença foi gritante. Instalação em 5 minutos!", rating: 5, photos: ["/images/eco/review-combo-3.webp"], daysAgo: 2 },
  ...
  { name: "Luciana Costa", avatar: "/images/avatar-carla.webp", text: "Minha conta reduziu de R$350 pra R$200! É impressionante como pagamos pelo ar que passa no hidrômetro. Recomendo!", rating: 5, photos: ["/images/eco/review-combo-1.webp", "/images/eco/review-combo-2.webp"], daysAgo: 1 },
  ...
  { name: "Thiago Mendes", avatar: "/images/avatar-karine.webp", text: "Produto com certificação INMETRO, isso me deu confiança. E realmente funciona! Economia real e comprovada.", rating: 4, photos: ["/images/eco/review-combo-3.webp"], daysAgo: 2 },
  ...
  { name: "Daniela Rocha", avatar: "/images/avatar-carla.webp", text: "Comprei 2 unidades e instalei em 10 minutos! A economia na conta foi imediata. Super recomendo!", rating: 5, photos: ["/images/eco/review-combo-2.webp"], daysAgo: 2 },
  ...
  { name: "Juliana Matos", avatar: "/images/avatar-juliana.webp", text: "Nota 1000! Economizei muito na conta de água. Instalação simples, produto de qualidade. Vou comprar pra toda família!", rating: 5, photos: ["/images/eco/review-combo-1.webp"], daysAgo: 2 },
];
